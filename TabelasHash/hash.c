...
tipo FILE*. Sua funcao � criar um arquivo, que futuramente ser� usado como
...
tipo FILE*. Sua funcao � eliminar o arquivo anterior.*/
void reescreveArquivo(FILE* arquivo){
 arquivo = fopen("hash2.txt", "w");
 fclose(arquivo);
}
...
Sua funcao � desenhar na tela os caracteres escolhidos pelo usuario com um certo
delay*/
...
/*O procedimento linha � similar ao linhaAnimada, mais sem delay*/
...
sua funcao � possibilitar que o programador modifique as cores do texto
ou do fundo*/
void cor(WORD cor){
...
. Sua funcao � possibilitar que o programador escolha a posicao na tela
